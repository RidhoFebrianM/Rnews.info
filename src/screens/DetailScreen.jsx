  ...
  return (
    <div className="min-h-screen bg-slate-900 pb-24">
      <div className="flex justify-between items-center p-4 sm:p-6 lg:p-8">
        <button 
          onClick={onBack}
          className="bg-gradient-to-r from-white/10 to-white/5 w-10 h-10 sm:w-12 sm:h-12 rounded-2xl flex items-center justify-center hover:from-white/20 hover:to-white/10 transition-all border border-white/10 shadow-lg"
        >
          <ArrowLeft className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
        </button>
        <button className="bg-gradient-to-r from-white/10 to-white/5 w-10 h-10 sm:w-12 sm:h-12 rounded-2xl flex items-center justify-center hover:from-white/20 hover:to-white/10 transition-all border border-white/10 shadow-lg">
          <Share2 className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
        </button>
      </div>

      <div className="px-4 sm:px-6 lg:px-8 text-center mb-6 sm:mb-8">
        <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-red-500 to-red-600 rounded-3xl mx-auto mb-5 sm:mb-6 flex items-center justify-center text-2xl sm:text-3xl font-bold shadow-2xl shadow-red-500/30">
          RN
        </div>
        ...
        <button 
          ...
          className={`px-8 sm:px-10 py-2.5 sm:py-3 rounded-full text-sm sm:text-base font-semibold mb-4 sm:mb-5 transition-all ${
            isFollowing 
              ...
              : 'bg-gradient-to-r from-red-500 to-red-600 text-white hover:scale-105 shadow-lg shadow-red-500/30'
          }`}
        >
      ...
      <div className="grid grid-cols-4 gap-4 sm:gap-6 bg-gradient-to-r from-white/5 to-white/[0.02] rounded-3xl mx-4 sm:mx-6 lg:mx-8 p-5 sm:p-6 lg:p-8 mb-6 sm:mb-8 border border-white/10 shadow-xl">
        {[
          ...
          <div key={idx} className="text-center">
            <div className="text-xl sm:text-2xl lg:text-3xl font-bold mb-1 sm:mb-2 text-white bg-gradient-to-r from-red-500 to-red-600 bg-clip-text">
              {stat.value}
            </div>
          ...
          <button
            ...
            className={`flex-1 py-3 sm:py-4 rounded-2xl text-sm sm:text-base font-semibold transition-all border ${
              activeTab === tab.toLowerCase()
                ? 'bg-gradient-to-r from-red-500 to-red-600 text-white shadow-lg shadow-red-500/30 border-transparent'
