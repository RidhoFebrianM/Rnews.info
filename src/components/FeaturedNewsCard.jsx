...
export const FeaturedNewsCard = ({ news, onBookmark, isBookmarked }) => {
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
      <div 
        className="relative rounded-3xl overflow-hidden h-80 sm:h-96 lg:h-[28rem] cursor-pointer hover:scale-[1.01] transition-all duration-300 shadow-2xl group"
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 sm:top-6 right-4 sm:right-6 bg-gradient-to-r from-red-500 to-red-600 w-11 h-11 sm:w-12 sm:h-12 rounded-2xl flex items-center justify-center hover:scale-110 transition-all z-10 shadow-2xl"
        >
